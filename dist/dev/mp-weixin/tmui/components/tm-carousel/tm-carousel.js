...
var tmui_components_tmCarousel_interface = require("./interface.js");
if (!Math) {
  (tmImage + tmSheet)();
}
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { emit: emits }) {
      ...
      props.list.forEach((el) => {
        ...
        if (typeof el == "string") {
          ...
          l.push({
            ...
            type: (_a = el == null ? void 0 : el.type) != null ? _a : tmui_components_tmCarousel_interface.listItemType.img,
            img: (_b = el == null ? void 0 : el.img) != null ? _b : "",
            ...el
          });
        }
      });
    ...
    function sliderChange(e) {
      var _a, _b;
      if (!_autoplay.value) {
        _current.value = (_a = e == null ? void 0 : e.detail) == null ? void 0 : _a.current;
      }
      ...
      return common_vendor.e({
        a: common_vendor.f(common_vendor.unref(_list), (item, index, i0) => {
          return common_vendor.e({
            ...
            l: common_vendor.o(($event) => emits("click", index)),
            m: index
          });
        }),
        ...
        t: common_vendor.f(common_vendor.unref(_list), (item, index, i0) => {
          return {
            a: common_vendor.o(($event) => dotClick(index)),
            b: index,
            c: "7e59e45c-2-" + i0,
            d: common_vendor.p({
              margin: [10, 10],
        ...
        aj: common_vendor.n(common_vendor.unref(_dotPosition) == "bottom" || common_vendor.unref(_dotPosition) == "top" ? "px-24 py-5 " : ""),
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/liziyang/data/vue/uni-preset-vue-vite-ts/src/tmui/components/tm-carousel/tm-carousel.vue"]]);
