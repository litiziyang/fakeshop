...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const tmcomputed = common_vendor.computed$1(() => {
      ...
      return tmui_tool_lib_minxs.computedTheme({ ...props, blur: _blur.value, text }, isDark.value, tmcfg.value);
    });
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        m: common_vendor.n(common_vendor.unref(parenClass_p)),
        n: common_vendor.n(`mx-${common_vendor.unref(_margin)[0]}`),
        o: common_vendor.n(`my-${common_vendor.unref(_margin)[1]}`),
        p: common_vendor.n(`px-${common_vendor.unref(_padding)[0]}`),
        q: common_vendor.n(`py-${common_vendor.unref(_padding)[1]}`),
        r: common_vendor.n(isLongPress.value ? props.hoverClass : ""),
        s: common_vendor.n(props.hoverClass != "" && props.hoverClass != "none" ? "webpc" : ""),
        t: common_vendor.n(!_ctx.isDisabledRoundAndriod ? `round-${props.round}` : ""),
        v: common_vendor.s(common_vendor.unref(_height) ? {
          height: common_vendor.unref(_height) + common_vendor.unref(_padding)[1] * 2 + props.unit
        } : ""),
        w: common_vendor.s(common_vendor.unref(_width) ? {
          width: common_vendor.unref(_width) + common_vendor.unref(_padding)[0] * 2 + props.unit
        } : ""),
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-f76eb362"], ["__file", "/Users/liziyang/data/vue/uni-preset-vue-vite-ts/src/tmui/components/tm-sheet/tm-sheet.vue"]]);
