...
class themeColors {
  ...
  getTheme(config = { colorname: "primary", dark: false }) {
    ...
    if (nowColor.hsla.h == 0 && nowColor.hsla.s == 0 && config.dark) {
      css.backgroundColor = tmui_tool_theme_colortool.colortool.rgbaToCss(tmui_tool_theme_colortool.colortool.hslaToRgba({ ...bghsl, l: 8 }));
    ...
    if (config.dark) {
      ...
      if (((_a = nowColor.hsla) == null ? void 0 : _a.l) <= 65) {
        txcolor.l = 95;
      } else {
        if (isGrey) {
          txcolor.l = 10;
